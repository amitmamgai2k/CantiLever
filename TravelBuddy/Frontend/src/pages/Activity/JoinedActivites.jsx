...
import { Loader2, MapPin, Users, Calendar, Search, Star, Clock, Zap, Loader2Icon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="mt-4 text-gray-600 font-medium">Discovering joined</p>
          </div>
        )}
                      ...
                      {activity.creator && (
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                          <div className="flex items-center space-x-3">
                           ...
                           <button className="px-4 py-2 text-white bg-red-500 text-sm font-medium rounded-lg transition-colors hover:bg-red-600 hover:border-white hober:shadow-md duration-200 group-hover:shadow-lg"
